            ...
            <div class="col-md-6 col-lg-5">
                <div class="card shadow-sm">
                    <div class="card-header bg-success text-white text-center py-3">
                        <h3 class="mb-0">Identifícate para Comprar</h3>
                    </div>
                    <div class="card-body p-4">
                        
                        <form action="login.html" method="POST">
                            <% 
                                // AQUÍ ESTÁ LA MAGIA: Leemos si el carrito nos ha mandado una URL de vuelta
                                String urlDestino = request.getParameter("url");
                                // Si por algún motivo entra sin destino, lo mandamos a la tienda por defecto
                                if (urlDestino == null || urlDestino.trim().isEmpty()) {
                                    urlDestino = "productos.html";
                                }
                            %>
                            ...
                            <div id="campos_registro" class="d-none">
                                <hr>
                                <h5 class="mb-3 text-secondary">Datos de facturación y entrega</h5>
                                <div class="row">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-success" id="btn_submit">Continuar con el Pago</button>
